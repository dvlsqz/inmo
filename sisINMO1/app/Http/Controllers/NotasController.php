...
class NotasController extends Controller
{
  ...
  public function index(Request $request){
    if($request){
      ...
      ->select('no.id','no.nota',DB::raw("asp.aspecto as aspecto"),DB::raw("est.nombre as nombre_estudiante"),DB::raw("est.apellido as apellido_estudiante"),DB::raw("cur.curso as curso"),DB::raw("te.tipo as tipo_evaluacion"))
  ...
  public function create(){
    ...
    return view("notas.nota.create",["aspectos"=>$aspectos,"estudiantes"=>$estudiantes,"cursos"=>$cursos,"tevaluaciones"=>$tevaluaciones]);
  }

...
public function store(TipoEvaluacionFormRequest $request /*Request $request*/){
  ...
  public function show($id){
    return view("notas.tipo_evaluacion.show",["genero"=>Generos::findOrFail($id)]);
  }

  public function edit($id){
    return view("notas.tipo_evaluacion.edit",["genero"=>Generos::findOrFail($id)]);
  }

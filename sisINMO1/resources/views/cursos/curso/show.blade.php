	  ...
	  <div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="grado_id" required value="{{$curso->grado}}" class="form-control" placeholder="Grado...">
				</div>
			</div>
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					...
					<input type="text" name="personal_id" required value="{{$curso->nombre_personal.' '.$curso->apellido_personal}}" class="form-control" placeholder="Personal...">
				</div>
			</div>

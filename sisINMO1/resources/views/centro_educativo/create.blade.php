...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'centro_educativo/','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
			{{Form::token()}}
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="telefono1" required value="{{old('telefono1')}}" class="form-control" placeholder="Telefono 1...">
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						...
						<input type="text" name="telefono2" required value="{{old('telefono2')}}" class="form-control" placeholder="Telefono 2...">
					</div>
				</div>

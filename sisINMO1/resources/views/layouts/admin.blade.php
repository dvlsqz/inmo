            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('notas/aspecto/')}}">Aspecto</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('notas/nota/')}}">Nota</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="{{url('notas/tipo_evaluacion/')}}">Tipo Evaluacion</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="{{url('cursos/curso/')}}">Curso</a></li>
                            <li><i class="menu-icon fa fa-street-view"></i><a href="{{url('cursos/horario/')}}">Horario</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-map-o"></i><a href="{{url('centro_educativo/')}}">Centro</a></li>
                        </ul>
                    </li>

            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                      ...
                      @if(Auth::user()->rol == "admin" || Auth::user()->rol == "secretaria" || Auth::user()->rol == "director")
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-home"></i>Centro Educativo</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-home"></i><a href="{{url('centro_educativo/')}}">Centro</a></li>
                        </ul>
                    </li>
                    @endif
